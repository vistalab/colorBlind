function pImg = sensorComputePhotonSamples(sensorNF,nSamp,noiseType,showBar)
...
if ieNotDefined('noiseType'), noiseType = 2; end

% Photon and electrical noise is typical.  But the user might ask for just
% photon if noise flag is 1.
